...
func seedData(db *database.DB) error {
	...
	golfContest := &models.Contest{
		...
		TotalEntries:         0,
		SalaryCap:            50000,
		StartTime:            time.Now().Add(24 * time.Hour), // Tournament starts tomorrow
		IsActive:             true,
		IsMultiEntry:         true,
		MaxLineupsPerUser:    20,
		PositionRequirements: models.GetPositionRequirements("golf", "draftkings"),
	}

	if err := db.Create(golfContest).Error; err != nil {
		return fmt.Errorf("failed to create golf contest: %w", err)
	}

	// Create sample golf players
	golfPlayers := []models.Player{
		// Top tier golfers
		{ExternalID: "pga_001", Name: "Scottie Scheffler", Team: "USA", Position: "G", Salary: 11500, ProjectedPoints: 75.5, FloorPoints: 60.0, CeilingPoints: 95.0, Ownership: 22.5, Sport: "golf", ContestID: golfContest.ID},
		{ExternalID: "pga_002", Name: "Jon Rahm", Team: "ESP", Position: "G", Salary: 11200, ProjectedPoints: 72.0, FloorPoints: 58.0, CeilingPoints: 90.0, Ownership: 20.0, Sport: "golf", ContestID: golfContest.ID},
		{ExternalID: "pga_003", Name: "Rory McIlroy", Team: "NIR", Position: "G", Salary: 10800, ProjectedPoints: 70.5, FloorPoints: 55.0, CeilingPoints: 88.0, Ownership: 18.5, Sport: "golf", ContestID: golfContest.ID},
		// Mid tier
		{ExternalID: "pga_004", Name: "Viktor Hovland", Team: "NOR", Position: "G", Salary: 10200, ProjectedPoints: 68.0, FloorPoints: 52.0, CeilingPoints: 85.0, Ownership: 16.0, Sport: "golf", ContestID: golfContest.ID},
		{ExternalID: "pga_005", Name: "Xander Schauffele", Team: "USA", Position: "G", Salary: 9800, ProjectedPoints: 65.5, FloorPoints: 50.0, CeilingPoints: 82.0, Ownership: 14.5, Sport: "golf", ContestID: golfContest.ID},
		{ExternalID: "pga_006", Name: "Patrick Cantlay", Team: "USA", Position: "G", Salary: 9500, ProjectedPoints: 64.0, FloorPoints: 48.0, CeilingPoints: 80.0, Ownership: 13.0, Sport: "golf", ContestID: golfContest.ID},
		{ExternalID: "pga_007", Name: "Max Homa", Team: "USA", Position: "G", Salary: 9200, ProjectedPoints: 62.5, FloorPoints: 46.0, CeilingPoints: 78.0, Ownership: 12.0, Sport: "golf", ContestID: golfContest.ID},
		{ExternalID: "pga_008", Name: "Jordan Spieth", Team: "USA", Position: "G", Salary: 8800, ProjectedPoints: 60.0, FloorPoints: 44.0, CeilingPoints: 76.0, Ownership: 11.0, Sport: "golf", ContestID: golfContest.ID},
		// Value plays
		{ExternalID: "pga_009", Name: "Tony Finau", Team: "USA", Position: "G", Salary: 8500, ProjectedPoints: 58.5, FloorPoints: 42.0, CeilingPoints: 74.0, Ownership: 10.5, Sport: "golf", ContestID: golfContest.ID},
		{ExternalID: "pga_010", Name: "Cameron Young", Team: "USA", Position: "G", Salary: 8200, ProjectedPoints: 56.0, FloorPoints: 40.0, CeilingPoints: 72.0, Ownership: 9.5, Sport: "golf", ContestID: golfContest.ID},
		{ExternalID: "pga_011", Name: "Sungjae Im", Team: "KOR", Position: "G", Salary: 7800, ProjectedPoints: 54.0, FloorPoints: 38.0, CeilingPoints: 70.0, Ownership: 8.5, Sport: "golf", ContestID: golfContest.ID},
		{ExternalID: "pga_012", Name: "Hideki Matsuyama", Team: "JPN", Position: "G", Salary: 7500, ProjectedPoints: 52.5, FloorPoints: 36.0, CeilingPoints: 68.0, Ownership: 8.0, Sport: "golf", ContestID: golfContest.ID},
		// Deep value
		{ExternalID: "pga_013", Name: "Shane Lowry", Team: "IRL", Position: "G", Salary: 7200, ProjectedPoints: 50.0, FloorPoints: 34.0, CeilingPoints: 65.0, Ownership: 7.0, Sport: "golf", ContestID: golfContest.ID},
		{ExternalID: "pga_014", Name: "Rickie Fowler", Team: "USA", Position: "G", Salary: 6800, ProjectedPoints: 48.0, FloorPoints: 32.0, CeilingPoints: 62.0, Ownership: 6.5, Sport: "golf", ContestID: golfContest.ID},
		{ExternalID: "pga_015", Name: "Adam Scott", Team: "AUS", Position: "G", Salary: 6500, ProjectedPoints: 45.5, FloorPoints: 30.0, CeilingPoints: 60.0, Ownership: 5.5, Sport: "golf", ContestID: golfContest.ID},
		{ExternalID: "pga_016", Name: "Russell Henley", Team: "USA", Position: "G", Salary: 6200, ProjectedPoints: 43.0, FloorPoints: 28.0, CeilingPoints: 58.0, Ownership: 4.5, Sport: "golf", ContestID: golfContest.ID},
		{ExternalID: "pga_017", Name: "Keith Mitchell", Team: "USA", Position: "G", Salary: 6000, ProjectedPoints: 40.5, FloorPoints: 26.0, CeilingPoints: 55.0, Ownership: 3.5, Sport: "golf", ContestID: golfContest.ID},
		{ExternalID: "pga_018", Name: "Chris Kirk", Team: "USA", Position: "G", Salary: 5800, ProjectedPoints: 38.0, FloorPoints: 24.0, CeilingPoints: 52.0, Ownership: 3.0, Sport: "golf", ContestID: golfContest.ID},
	}

	// Set tee times for golf players (groups of 3)
	baseTime := golfContest.StartTime
	for i := range golfPlayers {
		golfPlayers[i].GameTime = baseTime.Add(time.Duration(i/3) * 10 * time.Minute)
	}

	if err := db.Create(&golfPlayers).Error; err != nil {
		return fmt.Errorf("failed to create golf players: %w", err)
	}

	logrus.Infof("Seeded %d golf players for contest %s", len(golfPlayers), golfContest.Name)

	// Seed golf tournament
	golfTournament := &models.GolfTournament{
		ExternalID:   "pga-2025-masters",
		Name:         "The Masters Tournament",
		StartDate:    golfContest.StartTime,
		EndDate:      golfContest.StartTime.AddDate(0, 0, 4),
	...
	if err := db.Create(golfTournament).Error; err != nil {
		logrus.Warnf("Failed to seed golf tournament: %v", err)
	}

	// Create golf player entries linking players to tournament
	for _, player := range golfPlayers {
		entry := &models.GolfPlayerEntry{
			PlayerID:     player.ID,
			TournamentID: golfTournament.ID,
			Status:       models.EntryStatusEntered,
			DKSalary:     player.Salary,
			FDSalary:     player.Salary + 1000, // FanDuel typically higher
			DKOwnership:  player.Ownership,
			FDOwnership:  player.Ownership * 0.9,
		}
		if err := db.Create(entry).Error; err != nil {
			logrus.Warnf("Failed to create golf player entry: %v", err)
		}
	}

	logrus.Info("Seeded golf tournament and player entries")
