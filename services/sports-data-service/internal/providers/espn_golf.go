...
func NewESPNGolfClient(cache types.CacheProvider, logger *logrus.Logger) *ESPNGolfClient {
...
func (c *ESPNGolfClient) GetPlayers(sport types.Sport, date string) ([]types.PlayerData, error) {
...
func (c *ESPNGolfClient) GetPlayer(sport types.Sport, externalID string) (*types.PlayerData, error) {
...
func (c *ESPNGolfClient) GetTeamRoster(sport types.Sport, teamID string) ([]types.PlayerData, error) {
