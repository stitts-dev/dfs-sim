...
const (
	ServiceTypeGolf         ServiceType = "golf"
...
type Config struct {
	// Service Identity
	ServiceName ServiceType `mapstructure:"SERVICE_NAME"`
...
func setDefaults() {
	...
	// Service-specific port defaults
	viper.SetDefault("PORT", "8080") // Gateway default
	...
	viper.SetDefault("SKIP_INITIAL_GOLF_SYNC", false)
	viper.SetDefault("SKIP_INITIAL_DATA_FETCH", false)
	viper.SetDefault("SKIP_INITIAL_CONTEST_DISCOVERY", false)
	...
	viper.SetDefault("ENABLE_AUTO_PLAYER_FETCH", false)
	viper.SetDefault("ENABLE_BACKGROUND_JOBS", false)
	viper.SetDefault("GOLF_ONLY_MODE", true)
	viper.SetDefault("SUPPORTED_SPORTS", "golf")
...
func (c *Config) IsGolfService() bool {
	return c.ServiceName == ServiceTypeGolf
}

func (c *Config) IsOptimizationService() bool {
	return c.ServiceName == ServiceTypeOptimization
}

func (c *Config) IsGatewayService() bool {
	return c.ServiceName == ServiceTypeGateway
}