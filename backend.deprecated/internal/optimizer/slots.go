...
func CanPlayerFillSlot(player models.Player, slot PositionSlot) bool {
...
func AssignPlayersToSlots(players []models.Player, slots []PositionSlot) ([]SlotAssignment, error) {
